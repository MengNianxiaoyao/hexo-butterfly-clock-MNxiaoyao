...
hexo.extend.filter.register('after_generate', function (locals) {
  ...
  // 集体声明配置项
    const data = {
      ...
      loading: config.loading ? urlFor(config.loading) : "https://unpkg.com/hexo-butterfly-clock-mnxiaoyao/lib/loading.gif",
      clock_css: config.clock_css ? urlFor(config.clock_css) : "https://unpkg.com/hexo-butterfly-clock-mnxiaoyao/lib/clock.min.css",
      clock_js: config.clock_js ? urlFor(config.clock_js) : "https://unpkg.com/hexo-butterfly-clock-mnxiaoyaolib/clock.min.js",
